...
real (DP), parameter, private :: d1=1.000100133_DP*2.0_DP  ! dimensionless density == ration to initial number density
real (DP), parameter, private :: u1=1.500002946_DP ! dimensionless bulk velocity  -- ratio to C_{\infty}
real (DP), parameter, private :: v1=0.0_DP ! v1=?
real (DP), parameter, private :: w1=0.0_DP ! w1=?

! condtions after the shock wave 
real (DP), parameter, private :: T2=1.1_DP   !  dimensionless temperature  -- ratio to T_{\infyt}, 
real (DP), parameter, private :: d2=2.99990040001274_DP*2.0_DP   !  dimensionless density == ration to initial number density
real (DP), parameter, private :: u2=0.499995815_DP ! dimensionless bulk velocity  -- ratio to C_{\infty}
